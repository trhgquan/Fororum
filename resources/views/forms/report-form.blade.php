    ...
    <div class="panel-body">
        <form action="{{ route('report.handle') }}" method="POST">
            <div class="form-group">
                <label class="control-label">Please read this document carefully before submitting a report:</label>
                ...
                <p>Finally, <b>make sure the {{ ($section === 'profile') ? 'profile' : 'post' }} is going to be reported correctly</b>. Fake reports can make your account banned from the system.</p>
                <p>We appreciate your contribution to making this community better!</p>
            </div>
            <div class="form-group">
                <label>
            ...
            <div class="form-group {{ $errors->has('reason') ? 'has-error' : '' }}">
                ...
                <textarea class="form-control" name="reason" id="reason" placeholder="How can it violate our TERMS OF SERVICE? .." required></textarea>
